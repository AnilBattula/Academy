...
public class SignUpPage {
	...
	public By firstNameTextBox = By.xpath("//label[starts-with(@class,'label_') and contains( text(),'First name')] /form[starts-with(@class,'input_')]/input[@type='text']");
	
	/** The last name text box. */
	public By lastNameTextBox = By.xpath("//label[starts-with(@class,'label_') and contains( text(),'Last name')] /form[starts-with(@class,'input_')]/input[@type='text']");
